...
# label = ["NG", "OK"]
# df_con = pd.DataFrame(con, index=label, columns=label)
# heatmap = sn.heatmap(df_con, annot=True, cmap='Reds')
# heatmap.xaxis.set_ticklabels(heatmap.xaxis.get_ticklabels())
# heatmap.yaxis.set_ticklabels(heatmap.yaxis.get_ticklabels())
# plt.savefig("./graph/confusion matrix/confusion-matrix.png")
# plt.close()
